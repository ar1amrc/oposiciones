                ...
                <View style={styles.margin}>
                    ...
                    {edit ?
                        <View style={styles.nombre}>
                            <TextInput value={currentName} placeholder="Usuario" onChangeText={setCurrentName} style={styles.textInput} />
                    ...
                    <View style={styles.nombre}>
                        <StyledText fontSize='subheading' fontWeight='bold'> Orden Aleatorio</StyledText>
                        <Switch
                    ...
                    <View style={[styles.nombre, {marginTop: 50}]}>
                        <View style={{alignItems:'center'}}>
                            ...
                            <StyledText fontSize='subheading' fontWeight='bold'>Correctas</StyledText>
                        </View>
                        <View style={{alignItems:'center'}}>
                            <Text style={{marginBottom:5}}>{user.fallidas}</Text>
                            <StyledText fontSize='subheading' fontWeight='bold'>Incorrectas</StyledText>
                        </View>
                        <View style={{alignItems:'center'}}>
                            <Text style={{marginBottom:5}}>{Number(user.porciento).toFixed(2)}</Text>
                            <StyledText fontSize='subheading' fontWeight='bold'>% aciertos</StyledText>
                        </View>
                    </View>
                </View>
            </View>
